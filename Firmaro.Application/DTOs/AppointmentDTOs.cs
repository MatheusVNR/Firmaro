...
{
    public record CreateAppointmentRequest(string ClientName, string ClientPhone, DateTimeOffset DateTime);
    public record UpdateAppointmentRequest(string ClientName, string ClientPhone, DateTimeOffset DateTime);
